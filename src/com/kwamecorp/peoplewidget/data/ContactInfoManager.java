...
public class ContactInfoManager
{
    ...
    public void contactUsed(ContactInfo contactInfo)
    {
        ...
        ContactInfo cachedContact = _contactsInfoCache.get(contactInfo.phoneNumber);
        // if does not exist, create one
        if (cachedContact == null)
        {
            _contactsInfoCache.put(contactInfo.phoneNumber, contactInfo);
        ...
        Log.d(TAG, "Logging contact : " + cachedContact.phoneNumber + " : " + cachedContact.getCount());
    ...
    public List<ContactInfo> getAllAppRunInfo()
    {
    ...
    public void setAllContactInfo(List<ContactInfo> allApps)
    {
        ...
        {
            _contactsInfoCache.put(contact.phoneNumber, contact);
        }
